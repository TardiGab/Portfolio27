---
title: Reins
description: Réalisé dans le cadre de mon TFE, Reins est un tracker de collection de montures pour le jeu World of Warcraft. Il permet aux joueurs de suivre les montures qu'ils possèdent, de comparer leurs collections avec celles d'autres joueurs et de découvrir des guides pour obtenir des montures spécifiques.
year: 2026
projectType: Web App
...
<div className="mt-6 mb-6 flex flex-col md:flex-row md:gap-4">
  <CaseImage
    src="/images/case/reins/reins_guest-visiting-collection.webp"
    alt="Collection d'un utilisateur visitée par un invité"
    caption="Collection d'un utilisateur visitée par un invité"
  />
  <CaseImage
    src="/images/case/reins/reins_logged-in-visiting-collection.webp"
    alt="Message d'un utilisateur connecté visitant la collection d'un autre utilisateur"
    caption="Message d'un utilisateur connecté visitant la collection d'un autre utilisateur"
  />
</div>
